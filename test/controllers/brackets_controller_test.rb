...
class BracketsControllerTest < ActionController::TestCase
  ...
  test "should create bracket" do
    assert_difference('Bracket.count') do
      post :create, bracket: { isFinished: @bracket.isFinished, isStarted: @bracket.isStarted, reseed: @bracket.reseed, tournament_id: @bracket.tournament_id }
    end
  ...
  test "should update bracket" do
    patch :update, id: @bracket, bracket: { isFinished: @bracket.isFinished, isStarted: @bracket.isStarted, reseed: @bracket.reseed, tournament_id: @bracket.tournament_id }
    assert_redirected_to bracket_path(assigns(:bracket))
  end
