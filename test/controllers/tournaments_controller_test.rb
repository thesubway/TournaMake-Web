...
class TournamentsControllerTest < ActionController::TestCase
  ...
  test "should create tournament" do
    assert_difference('Tournament.count') do
      post :create, tournament: { format: @tournament.format, name: @tournament.name }
    end
  ...
  test "should update tournament" do
    patch :update, id: @tournament, tournament: { format: @tournament.format, name: @tournament.name }
    assert_redirected_to tournament_path(assigns(:tournament))
  end
